        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div>
            ...
            <nav className="flex flex-col gap-2">
              <Link href="/regions" className="text-muted-foreground hover:text-foreground text-sm font-bold transition-colors">Global Regions</Link>
              <Link href="/conferences" className="text-muted-foreground hover:text-foreground text-sm font-bold transition-colors">Conferences</Link>
              <Link href="/membership" className="text-muted-foreground hover:text-foreground text-sm font-bold transition-colors">Become a Member</Link>
              <Link href="/store" className="text-muted-foreground hover:text-foreground text-sm font-bold transition-colors">Party Store</Link>
              <Link href="/donate" className="text-muted-foreground hover:text-foreground text-sm font-bold transition-colors">Donate</Link>
            </nav>
          </div>
          ...
          <div>
            ...
            <nav className="flex flex-col gap-2">
              <Link href="/fundraise" className="text-muted-foreground hover:text-foreground text-sm font-bold transition-colors">Fundraise</Link>
              <Link href="/campaigns" className="text-muted-foreground hover:text-foreground text-sm font-bold transition-colors">Campaigns</Link>
              <Link href="/blog" className="text-muted-foreground hover:text-foreground text-sm font-bold transition-colors">Blog</Link>
              <Link href="/auctions" className="text-muted-foreground hover:text-foreground text-sm font-bold transition-colors">Auctions</Link>
              <Link href="/songs" className="text-muted-foreground hover:text-foreground text-sm font-bold transition-colors">Songs</Link>
              <Link href="/gallery" className="text-muted-foreground hover:text-foreground text-sm font-bold transition-colors">Advocacy Rallies</Link>
              <Link href="/fallen-heroes" className="text-muted-foreground hover:text-foreground text-sm font-bold transition-colors">Fallen Heroes</Link>
            </nav>
          </div>
