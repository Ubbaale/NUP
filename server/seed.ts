  ...
  try {
    ...
    const tiersData = [
      ...
      },
      {
        ...
        benefits: JSON.stringify(["All Advocate benefits", "Direct messaging with chapter leaders", "Name on donor wall", "Annual convention VIP access", "Signed merchandise", "NUP champion badge", "Engraved trophy shipped to you"]),
        badgeColor: "#F97316",
        awardType: "trophy",
        awardDescription: "A premium NUP trophy engraved with your name — honoring your outstanding commitment to the People Power movement.",
        isPopular: false,
        isActive: true,
        displayOrder: 3,
      },
